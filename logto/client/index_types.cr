...
# @attr [Array<String>] prompt The prompt parameter to be used for the authorization request.
  class Config
    ...
    def initialize(endpoint? : String | URI, app_id? : String, app_secret? : String, scopes? : Array = [String], resources? : Array = [String], prompt? : Array = LogtoCore::PROMPT[:consent], include_reserved_scopes? : Bool = true)
